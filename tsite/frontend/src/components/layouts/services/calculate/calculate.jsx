    ...
    <S.PageWrapper>
      <S.ContentRow>
        <S.Icon>
          <img
            src={placeholder}
            alt="Замер территории для укладки плитки"
          />
        </S.Icon>
        <S.Description>
          <p>
          ...
          <p>
            Точные замеры позволяют расчитать количество требуемой тротуарной плитки и основных сопутствующих
            материалов, таких как геотекстиль, цемент, отсев, бордюр и отливы. У Вас не будут
            накапливаться оставшиеся строительные материалы, тем самым Вы значительно сэкономите на расходах.
          </p>
        </S.Description>
      </S.ContentRow>
      <S.DiscoverPriceRow>
